...
namespace PlasmaFileReader.Plasma.Classes
{
	...
	public class RenderQueueController : Controller
	{
		...
		public override void Init()
		{
			...
			RenderQueueController.temporaryTexture2D = new Texture2D(Controllers.assetController.textureWidth, Controllers.assetController.textureHeight, Controllers.assetController.userTextureFormat, false);
					...
					case RenderQueueController.Operation.Types.ExportImage:
						{
							...
							Texture2D texture2D2 = new Texture2D(texture2D.width, texture2D.height, Controllers.assetController.userTextureFormat, false);
