...
namespace Plasma
{
    ...
    {
        static readonly Guid LocalLowId = new("A520A1A4-1780-4FF6-BD18-167343C5AF16");
        ...
        static readonly string SecondLevelPath = Path.Combine("DryLicorice", "Plasma", "User Data");
